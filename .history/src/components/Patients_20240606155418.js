      ...
      .then(data => {
        const patientNames = data.entry.map(entry => {
          ...
          return {
            ...
            familyName: name.family, // Add this line to store the family name
            birthDate: entry.resource.birthDate, // Add this line to store the birth date
...
const filteredPatients = patients.filter(patient =>
    patient.familyName.toLowerCase().startsWith(searchTerm.toLowerCase())
  );

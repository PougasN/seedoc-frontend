      ...
      fetch('http://localhost:9090/media', {
        ...
        .then(() => {
          ...
          const updatedEncounter = {
            resourceType: "Encounter",
            id: encounterToUpdate.id,
            meta: encounterToUpdate.meta,
            status: "in-progress",
            subject: encounterToUpdate.subject,
            period: encounterToUpdate.period,
            reasonCode: encounterToUpdate.reasonCode,
          };
